            ...
            <footer class="footer-light">
                <div class="container">
                    <div class="row">
						<div class="col-lg-4">
                            <div class="widget">
                                <a href="../index.html"><img alt="" we class="footer-img" src="../images/footer.png"></a>
                                <div class="spacer-20"></div>
                                <p>You can easily get the watch hours and views you want using our website.</p>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-6 sm-text-center mb-sm-30">
                            <div class="mt10">&copy; Copyright 2021 - <a href="https://trafforyou.com/">Trafforyou.com</a></div>
                        </div>
