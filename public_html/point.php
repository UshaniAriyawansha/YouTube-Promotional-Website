...
if(isset($_SESSION['admin'])){
    ...
    $sql    = "SELECT reg,ref,refa,vv,wv,avv,avw,web FROM point";
    $res    = $conn->query($sql);
            ...
            <div class='card-body'>
                ...
                <div class='row'>
                    ...
                    <div class='form-group col-md-5 col-12'>
                        ...
                        <input type='text' id='vvp' class='form-control' value='{$data['web']}'>
                    </div>
                </div>
                ...
                <div class='row'>
                    ...
                    <div class='form-group col-md-5 col-12'>
                        ...
                        <input type='text' id='avwp' class='form-control' value='{$data['avw']}'>
                    </div>
                </div>
...
function change(){
    var regp  = document.getElementById('reg').value;
    var refp  = document.getElementById('ref').value;
    var refap = document.getElementById('refa').value;
    var vvp   = document.getElementById('vv').value;
    var wvp   = document.getElementById('wv').value;
    alert(wv);
    var avvp  = document.getElementById('avv').value;
    var avwp  = document.getElementById('avw').value;
    var webp  = document.getElementById('web').value;
    var key   = document.getElementById('key').value;
    alert(key);
    var data = 'reg='+regp+'&ref='+refp+'&refa='+refap+'&vv='+vvp+'&wa='+wvp+'&avv='+avvp+'&avw='+avwp+'&web='+webp+'&key='+key;
    alert(data);
}
</script>